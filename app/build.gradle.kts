...
android {
    namespace = "com.example.multimodulemovieapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.multimodulemovieapp"
        minSdk = 30
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(project(":feature:playing_movie:ui"))
    implementation(project(":feature:playing_movie:domain"))
    implementation(project(":feature:playing_movie:data"))
